...
<template>
    <div class="flex flex-wrap" :class="{ dark: styleStore.darkMode }">
        <div class="w-full sm:w-full md:w-full lg:w-3/5 xl:w-3/5 lg:bg-gray-500">
            <div
        ...
        <div class="w-full sm:w-full md:w-full lg:w-2/5 xl:w-2/5 lg:bg-gray-500">
            <div
                ...
                <div class="w-full  sm:max-w-md">
                    <h1 class="font-bold">Welcome To MEIDE Babysitting CRM</h1>
