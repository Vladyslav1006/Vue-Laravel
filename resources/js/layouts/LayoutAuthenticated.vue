...
<template>
  <div :class="{
    ...
    <div :class="[{ 'ml-60 lg:ml-0': isAsideMobileExpanded }, isAsideXlExpanded ? 'xl:pl-60' : 'xl:pl-14']"
      ...
      <NavBar :menu="menuNavBar" :class="[
        ...
        <NavBarItemPlain display="flex hidden xl:flex" @click.prevent="menuExpanded()">
          <BaseIcon :path="isAsideXlExpanded ? mdiBackburger : mdiForwardburger" size="24" />
        </NavBarItemPlain>
      ...
      <AsideMenu :is-aside-mobile-expanded="isAsideMobileExpanded" :is-aside-xl-expanded="isAsideXlExpanded"
        :is-aside-lg-active="isAsideLgActive" :menu="menuAside" @menu-click="menuClick"
