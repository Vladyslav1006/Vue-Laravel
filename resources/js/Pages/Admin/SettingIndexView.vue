    ...
    <LayoutAuthenticated>
        ...
        <SectionMain>
            <SectionTitleLineWithButton :icon="mdiPackage" title="Settings" main>
                <div class="flex">
                    <Link :href="route('setting.create')" v-if="can.all || can.setting_create">
