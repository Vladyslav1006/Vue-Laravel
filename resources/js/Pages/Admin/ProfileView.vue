        ...
        <form @submit.prevent="submitform" autocomplete="off">
          <CardBox is-form @submit.prevent="submitProfile">
            <FormField label="Name" help="" :error="form.errors.name">
              <FormControl name="name" v-model="form.name" :required="(props.can.all || props.can['user_edit'])"
                :disabled="(!((props.can.all || props.can['user_edit'])))" />
            </FormField>
            <FormField v-if="(props.can.all || props.can['user_edit'])" label="Email" help="" :error="form.errors.email">
              <FormControl name="email" v-model="form.email" required />
            </FormField>
            <FormField v-if="(props.can.all || props.can['user_edit'])" label="Phone" help="" :error="form.errors.phn">
              <FormControl name="phn" v-model="form.phn" required />
            </FormField>
            ...
            <FormField label="2FA" v-if="(props.can.all || props.can['user_edit'])">
