...
const computedType = computed(() => (props.options ? "select" : (props.type == 'password' ? (showHidepassword.value ? 'password' : 'text') : props.type)));
...
<template>
  <div class="relative">
    ...
    <input v-else :id="id" ref="inputEl" v-model="computedValue" :name="name" :maxlength="maxlength"
      :inputmode="inputmode" :autocomplete="autocomplete" :required="required" :disabled="disabled"
      :placeholder="placeholder" :type="computedType" :class="inputElClass" @focus="emit('focus', $event.target.value)"
      @blur="emit('blur', $event.target.value)" />
    <FormControlIcon v-if="icon" :icon="icon" :h="controlIconH" />
    <div @click="togglePassword" v-if="props.type === 'password'"
